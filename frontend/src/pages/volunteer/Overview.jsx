...
const Overview = () => {
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-[1400px] mx-auto bg-white min-h-screen">
      ...
      >
        <h1 className="text-[#01070f] text-2xl sm:text-3xl md:text-[32px] font-bold mb-2 font-['Montserrat']">
          Dashboard Overview
        </h1>
        <p className="text-gray-600 text-xs sm:text-sm">
          Welcome back! Here's what's happening with your volunteer activities.
        </p>
      </motion.div>
