...
const Sidebar = ({ collapsed, setCollapsed, mobileOpen, setMobileOpen }) => {
  ...
  return (
    <>
      ...
      <div 
        id="mobile-sidebar"
        className={`fixed left-0 top-0 h-screen bg-[#01070f] py-6 px-3 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] z-[100] shadow-[4px_0_16px_rgba(0,0,0,0.3)] border-r border-white/5 
          ${collapsed ? 'w-20' : 'w-60'}
      ...
      >
        <div className="flex items-center justify-between mb-10 px-2">
          ...
          <button 
            className="w-8 h-8 bg-white/10 rounded-lg text-white flex items-center justify-center cursor-pointer hover:bg-white/20 transition-all duration-300 hidden lg:flex"
        ...
        {!collapsed && (
          <div className="absolute bottom-6 left-3 right-3 pt-4 text-center border-t border-white/10">
            <p className="text-white/50 text-xs m-0 mb-1">© 2026 Vaani</p>
